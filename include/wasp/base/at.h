...
// Add operator== overloads for nullopt comparisons
template <typename T>
bool operator==(const At<std::nullopt_t>& lhs, const std::optional<At<T>>& rhs) {
  return !rhs.has_value();
}

template <typename T>
bool operator==(const std::optional<At<T>>& lhs, const At<std::nullopt_t>& rhs) {
